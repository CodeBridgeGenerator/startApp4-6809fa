...
payload: { type: Schema.Types.Mixed , comment: "payload, p, false, true, true, true, true, true, true, , , , ," },
status: { type:  String , comment: "Status, p, false, true, true, true, true, true, true, , , , ," },
successCount: { type: Number, max: 1000000, comment: "successCount, p_number, false, true, true, true, true, true, true, , , , ," },
failureCount: { type: Number, max: 1000000, comment: "failureCount, p_number, false, true, true, true, true, true, true, , , , ," },
