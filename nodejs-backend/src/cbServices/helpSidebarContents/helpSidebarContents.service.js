const { HelpSidebarContents } = require("./helpSidebarContents.class");
const createModel = require("./helpSidebarContents.model");
const hooks = require("./helpSidebarContents.hooks");
...
module.exports = function (app) {
  ...
  app.use("/helpSidebarContents", new HelpSidebarContents(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("helpSidebarContents");

  // Get the schema of the collections 
  app.get("/helpSidebarContentsSchema", function (request, response) {
