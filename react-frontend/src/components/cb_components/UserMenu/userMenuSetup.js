...
const Home = (props) => {
  ...
  const CB_ADMIN_SERVICES = new Set([
    ...
    "userChangePassword",
    "userGuide",
    "loginHistory", "departmentAdmin", "departmentHOD", "departmentHOS", "errorsWH", "fcm", "mailWH", "userGuide", "uploader"
  ...
  const handleAddSubSubmenu = (menuIndex, submenuIndex) => {
    setFormData((prev) => {
      ...
      updatedMenuItems[menuIndex].submenus[submenuIndex] = {
        ...updatedMenuItems[menuIndex].submenus[submenuIndex],
        subSubmenus: [...currentSubSubmenus, {
          name: "",
          routePage: "",
          icon: ""
        }],
          ...
          <ul className="list-none p-0 m-0 flex flex-column md:flex-row mt-6">
            {["User Context", "Menu Items", "Preview"].map((step, index) => (
              ...
              >
                {/* Step Indicator */}
                <div
                  className={`border-round p-3 surface-card flex flex-column md:flex-row align-items-center z-1 ${activeStep === index + 1
                    ? "border-2 border-blue-500"
                    : "border-1 border-300"
                    }`}
                >
                  <i
                    className={`pi ${activeStep > index + 1
                          ...
                          <div className="p-fluid grid mb-3">
                            <div className="field col-12 md:col-4">
                              ...
                              <InputText
                                value={menu.name}
                                onChange={(e) =>
                                  handleMenuChange(menuIndex, "name", e.target.value)
                                }
                            ...
                            <div className="field col-12 md:col-4">
                              ...
                              <Dropdown
                                ...
                                onChange={(e) =>
                                  handleMenuChange(menuIndex, "routePage", e.value)
                                }
                                ...
                                <div className="flex align-items-center justify-content-between mb-2">
                                  <div className="flex align-items-center">
                                    <Button
                                      ...
                                      onClick={() => toggleSubmenuCollapse(menuIndex, submenuIndex)}
                                      className="p-button-text mr-2"
                                    />
                                    <span className="font-medium">Submenu {submenuIndex + 1}</span>
                                    <span className="ml-2 text-sm text-gray-500">
                                      ({submenu.subSubmenus?.length || 0} sub-submenus)
                                    </span>
                                  </div>
                                  <Button
                                    icon="pi pi-trash"
                                    className="p-button-danger p-button-sm p-button-text"
                                    onClick={() => handleDeleteSubmenu(menuIndex, submenuIndex)}
                                    ...
                                    <div className="ml-4">
                                      <div className="flex justify-content-between align-items-center mb-2">
                                        ...
                                        <Button
                                          ...
                                          icon="pi pi-plus"
                                          onClick={() => handleAddSubSubmenu(menuIndex, submenuIndex)}
                                          ...
                                          <div key={subSubmenuIndex} className="mb-2 p-3 border-round surface-100">
                                            <div className="flex align-items-center justify-content-between mb-2">
                                              ...
                                              <Button
                                                icon="pi pi-trash"
                                                className="p-button-danger p-button-sm p-button-text"
                                                onClick={() => handleDeleteSubSubmenu(menuIndex, submenuIndex, subSubmenuIndex)}
